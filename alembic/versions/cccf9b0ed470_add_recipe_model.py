...
def upgrade() -> None:
    ...
    sa.Column('peopleCount', sa.Integer(), nullable=True, server_default=1),
    sa.Column('likesCount', sa.Integer(), nullable=True, server_default=0),
    sa.Column('forkedCount', sa.Integer(), nullable=True, server_default=0),
    sa.Column('isDeleted', sa.Boolean(), nullable=True, server_default=False),
    sa.Column('isHide', sa.Boolean(), nullable=True, server_default=False),
